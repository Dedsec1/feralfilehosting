...
sleep 5
echo Some things thing you must do in the screen configuration: Enter the email you registered with when prompted,Enter you password for this account when prompted,Enter the path you want for you Aerofs folder when prompted. This path will ~/Aerofs by default if you just press enter,When the set-up is complete press this keyboard sequence to detach from the screen:"
sleep 5
